...
if "%~1"=="--analysis-only" (
   set "./scripts/analytical_backbone/feature_engineering/feature_generation.py ./scripts/analytical_backbone/feature_engineering/labelling.py ./scripts/analytical_backbone/feature_engineering/data_preparation.py ./scripts/analytical_backbone/model_generation/model_generation.py"
)
